...
sudo k3s kubectl delete -f ./src/main/k3s/fishs-database.yaml
sudo k3s kubectl delete -f ./src/main/k3s/fishs-cm.yaml
sudo k3s kubectl delete -f ./src/main/k3s/fishs-application.yaml
